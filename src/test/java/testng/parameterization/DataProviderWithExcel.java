...
public class DataProviderWithExcel {
    ...
    public Object[][] getDataProviderFunction() throws IOException {
        Object[][] arrayObject = getExcelData("D:\\classes\\TestNGDemoForMorningBatch.xlsx", "TestCases");

        return arrayObject;
    }

    public static Object[][] getExcelData(String filPath, String sheetName) throws IOException {
        FileInputStream fp = new FileInputStream(filPath);
